    ...
    public static class PermissionDeniedDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage("Permission was denied")
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            if (finishActivity) {
                Toast.makeText(getActivity(), "Permission to access location is required to use this application effectively",
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            if (finishActivity) {
                Toast.makeText(getActivity(),
                       "location is required, mandatory",
                        Toast.LENGTH_SHORT)
                        .show();
                getActivity().finish();
            }
